...
値の取得は「.val()」を使用します。</div></details>

## Q-3. inputの値を取得する練習をしてみましょう
...
プログラミングでよくあるパターンであり、他の言語でも同じ様に配列の最後を削除する技術はあります。
</div></details>
...
縦と横の両方取得でき、『あるスクロール値になれば...ポップアップを表示する』など、実務ではよく使用されます 。<br>
縦でも横でも値をとれるようにしておきましょう。
</div></details>

## Q-8. 要素内の最後に要素を追加してみましょう
...
<details><summary>解説</summary><div>
 $('input').val()) の表記、非常に頻出の記載方法です。<br>
 append()で要素の最後に追加することができます。

</div></details>

## Q-9. ダブルクリック時の処理を体験してみましょう
...
<details><summary>解説</summary><div>
ダブルクリックイベントもよく使用する技術です。
</div></details>

## Q-10. key upの仕組みを知りましょう
